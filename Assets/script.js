...
var apiKey = "37bc77bf6931bb85bef928e619baf386";
//adds timezones
...
var todayForecast = document.querySelector('#forecast');
var fiveDayForecast = document.querySelector('#5DayForecast');
...
function renderCurrentWeather(city, weather, timezone) {
  ...
  function fetchWeather(location) {
    ...
    var apiUrl = `${requestURL}/data/2.5/onecall?lat=${lat}&lon=${lon}&units=imperial&exclude=minutely,hourly&appid=${weatherApiKey}`;
